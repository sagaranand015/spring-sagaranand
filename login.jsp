...
<!DOCTYPE html>
<html ng-app="monitorApp" ng-controller="loginController">
<head>
<meta charset="UTF-8">
...
<body ng-cloak id="{{headerMenu.logo.name}}">
	...
	<div class="wrapper">
		...
		<div class="content-section section-padding container"
			ng-controller="loginMainController">

			<!-- Section Header -->
			<header class="section-header text-center">
				<div class="heading-title heading-line-double text-center">
					<h2 ng-cloak>{{login.headline}}</h2>
				</div>
			</header>
			<!-- /Section Header -->
...
<script src="app/login/loginMainController.js"></script>
